# -*- generated by 1.0.14 -*-
import da
PatternExpr_362 = da.pat.TuplePattern([da.pat.ConstantPattern('TXN'), da.pat.FreePattern('payload')])
PatternExpr_369 = da.pat.FreePattern('client')
PatternExpr_401 = da.pat.TuplePattern([da.pat.ConstantPattern('PROPOSAL'), da.pat.FreePattern('proposal'), da.pat.FreePattern('sender_id')])
PatternExpr_410 = da.pat.FreePattern('sender')
PatternExpr_431 = da.pat.TuplePattern([da.pat.ConstantPattern('VOTE'), da.pat.FreePattern('vote_msg'), da.pat.FreePattern('sender_id')])
PatternExpr_440 = da.pat.FreePattern('sender')
_config_object = {}
...
class Node(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_NodeReceivedEvent_0', PatternExpr_362, sources=[PatternExpr_369], destinations=None, timestamps=None, record_history=None, handlers=[self._Node_handler_361]), da.pat.EventPattern(da.pat.ReceivedEvent, '_NodeReceivedEvent_1', PatternExpr_401, sources=[PatternExpr_410], destinations=None, timestamps=None, record_history=None, handlers=[self._Node_handler_400]), da.pat.EventPattern(da.pat.ReceivedEvent, '_NodeReceivedEvent_2', PatternExpr_431, sources=[PatternExpr_440], destinations=None, timestamps=None, record_history=None, handlers=[self._Node_handler_430])])

    def setup(self, node_id, nodes, nodesDict, **rest_791):
        super().setup(node_id=node_id, nodes=nodes, nodesDict=nodesDict, **rest_791)
        ...
        self._state.leader_election = LeaderElection.LeaderElection(self._state.nodesDict, 10, 10, {}, self._state.pacemaker, self._state.ledger, self._state.node_id)
    ...
    def process_new_round_event(self, last_tc):
        if (self._state.node_id == self._state.leader_election.get_leader(self._state.pacemaker.current_round)):
            self.output('[Node] [{}] Leader Elected'.format(self._state.node_id))
    ...
    def _Node_handler_361(self, payload, client):
        ...
        self.process_new_round_event(None)
    _Node_handler_361._labels = None
    _Node_handler_361._notlabels = None

    def _Node_handler_400(self, proposal, sender_id, sender):
    ...
    _Node_handler_400._labels = None
    _Node_handler_400._notlabels = None

    def _Node_handler_430(self, vote_msg, sender_id, sender):
    ...
    _Node_handler_430._labels = None
    _Node_handler_430._notlabels = None
